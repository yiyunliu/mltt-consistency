...
Lemma congr_tIf  { s0 : tm   } { s1 : tm   } { s2 : tm   } { s3 : tm   } { t0 : tm   } { t1 : tm   } { t2 : tm   } { t3 : tm   } (H1 : s0 = t0) (H2 : s1 = t1) (H3 : s2 = t2) (H4 : s3 = t3) : tIf  s0 s1 s2 s3 = tIf  t0 t1 t2 t3 .
Proof. congruence. Qed.
...
Lemma congr_tJ  { s0 : tm   } { s1 : tm   } { s2 : tm   } { s3 : tm   } { s4 : tm   } { t0 : tm   } { t1 : tm   } { t2 : tm   } { t3 : tm   } { t4 : tm   } (H1 : s0 = t0) (H2 : s1 = t1) (H3 : s2 = t2) (H4 : s3 = t3) (H5 : s4 = t4) : tJ  s0 s1 s2 s3 s4 = tJ  t0 t1 t2 t3 t4 .
Proof. congruence. Qed.
...
Fixpoint ren_tm   (xitm : ( fin ) -> fin) (s : tm ) : tm  :=
    ...
    | tTrue   => tTrue 
    | tFalse   => tFalse 
    | tIf  s0 s1 s2 s3 => tIf  ((ren_tm (upRen_tm_tm xitm)) s0) ((ren_tm xitm) s1) ((ren_tm xitm) s2) ((ren_tm xitm) s3)
    | tBool   => tBool 
    | tEq  s0 s1 s2 => tEq  ((ren_tm xitm) s0) ((ren_tm xitm) s1) ((ren_tm xitm) s2)
    | tJ  s0 s1 s2 s3 s4 => tJ  ((ren_tm (upRen_tm_tm (upRen_tm_tm xitm))) s0) ((ren_tm xitm) s1) ((ren_tm xitm) s2) ((ren_tm xitm) s3) ((ren_tm xitm) s4)
    | tRefl   => tRefl 
    end.
...
Fixpoint subst_tm   (sigmatm : ( fin ) -> tm ) (s : tm ) : tm  :=
    ...
    | tTrue   => tTrue 
    | tFalse   => tFalse 
    | tIf  s0 s1 s2 s3 => tIf  ((subst_tm (up_tm_tm sigmatm)) s0) ((subst_tm sigmatm) s1) ((subst_tm sigmatm) s2) ((subst_tm sigmatm) s3)
    | tBool   => tBool 
    | tEq  s0 s1 s2 => tEq  ((subst_tm sigmatm) s0) ((subst_tm sigmatm) s1) ((subst_tm sigmatm) s2)
    | tJ  s0 s1 s2 s3 s4 => tJ  ((subst_tm (up_tm_tm (up_tm_tm sigmatm))) s0) ((subst_tm sigmatm) s1) ((subst_tm sigmatm) s2) ((subst_tm sigmatm) s3) ((subst_tm sigmatm) s4)
    | tRefl   => tRefl 
    end.
...
Fixpoint idSubst_tm  (sigmatm : ( fin ) -> tm ) (Eqtm : forall x, sigmatm x = (var_tm ) x) (s : tm ) : subst_tm sigmatm s = s :=
    ...
    | tTrue   => congr_tTrue 
    | tFalse   => congr_tFalse 
    | tIf  s0 s1 s2 s3 => congr_tIf ((idSubst_tm (up_tm_tm sigmatm) (upId_tm_tm (_) Eqtm)) s0) ((idSubst_tm sigmatm Eqtm) s1) ((idSubst_tm sigmatm Eqtm) s2) ((idSubst_tm sigmatm Eqtm) s3)
    | tBool   => congr_tBool 
    | tEq  s0 s1 s2 => congr_tEq ((idSubst_tm sigmatm Eqtm) s0) ((idSubst_tm sigmatm Eqtm) s1) ((idSubst_tm sigmatm Eqtm) s2)
    | tJ  s0 s1 s2 s3 s4 => congr_tJ ((idSubst_tm (up_tm_tm (up_tm_tm sigmatm)) (upId_tm_tm (_) (upId_tm_tm (_) Eqtm))) s0) ((idSubst_tm sigmatm Eqtm) s1) ((idSubst_tm sigmatm Eqtm) s2) ((idSubst_tm sigmatm Eqtm) s3) ((idSubst_tm sigmatm Eqtm) s4)
    | tRefl   => congr_tRefl 
    end.
...
Fixpoint extRen_tm   (xitm : ( fin ) -> fin) (zetatm : ( fin ) -> fin) (Eqtm : forall x, xitm x = zetatm x) (s : tm ) : ren_tm xitm s = ren_tm zetatm s :=
    ...
    | tTrue   => congr_tTrue 
    | tFalse   => congr_tFalse 
    | tIf  s0 s1 s2 s3 => congr_tIf ((extRen_tm (upRen_tm_tm xitm) (upRen_tm_tm zetatm) (upExtRen_tm_tm (_) (_) Eqtm)) s0) ((extRen_tm xitm zetatm Eqtm) s1) ((extRen_tm xitm zetatm Eqtm) s2) ((extRen_tm xitm zetatm Eqtm) s3)
    | tBool   => congr_tBool 
    | tEq  s0 s1 s2 => congr_tEq ((extRen_tm xitm zetatm Eqtm) s0) ((extRen_tm xitm zetatm Eqtm) s1) ((extRen_tm xitm zetatm Eqtm) s2)
    | tJ  s0 s1 s2 s3 s4 => congr_tJ ((extRen_tm (upRen_tm_tm (upRen_tm_tm xitm)) (upRen_tm_tm (upRen_tm_tm zetatm)) (upExtRen_tm_tm (_) (_) (upExtRen_tm_tm (_) (_) Eqtm))) s0) ((extRen_tm xitm zetatm Eqtm) s1) ((extRen_tm xitm zetatm Eqtm) s2) ((extRen_tm xitm zetatm Eqtm) s3) ((extRen_tm xitm zetatm Eqtm) s4)
    | tRefl   => congr_tRefl 
    end.
...
Fixpoint ext_tm   (sigmatm : ( fin ) -> tm ) (tautm : ( fin ) -> tm ) (Eqtm : forall x, sigmatm x = tautm x) (s : tm ) : subst_tm sigmatm s = subst_tm tautm s :=
    ...
    | tTrue   => congr_tTrue 
    | tFalse   => congr_tFalse 
    | tIf  s0 s1 s2 s3 => congr_tIf ((ext_tm (up_tm_tm sigmatm) (up_tm_tm tautm) (upExt_tm_tm (_) (_) Eqtm)) s0) ((ext_tm sigmatm tautm Eqtm) s1) ((ext_tm sigmatm tautm Eqtm) s2) ((ext_tm sigmatm tautm Eqtm) s3)
    | tBool   => congr_tBool 
    | tEq  s0 s1 s2 => congr_tEq ((ext_tm sigmatm tautm Eqtm) s0) ((ext_tm sigmatm tautm Eqtm) s1) ((ext_tm sigmatm tautm Eqtm) s2)
    | tJ  s0 s1 s2 s3 s4 => congr_tJ ((ext_tm (up_tm_tm (up_tm_tm sigmatm)) (up_tm_tm (up_tm_tm tautm)) (upExt_tm_tm (_) (_) (upExt_tm_tm (_) (_) Eqtm))) s0) ((ext_tm sigmatm tautm Eqtm) s1) ((ext_tm sigmatm tautm Eqtm) s2) ((ext_tm sigmatm tautm Eqtm) s3) ((ext_tm sigmatm tautm Eqtm) s4)
    | tRefl   => congr_tRefl 
    end.
...
Fixpoint compRenRen_tm    (xitm : ( fin ) -> fin) (zetatm : ( fin ) -> fin) (rhotm : ( fin ) -> fin) (Eqtm : forall x, ((funcomp) zetatm xitm) x = rhotm x) (s : tm ) : ren_tm zetatm (ren_tm xitm s) = ren_tm rhotm s :=
    ...
    | tTrue   => congr_tTrue 
    | tFalse   => congr_tFalse 
    | tIf  s0 s1 s2 s3 => congr_tIf ((compRenRen_tm (upRen_tm_tm xitm) (upRen_tm_tm zetatm) (upRen_tm_tm rhotm) (up_ren_ren (_) (_) (_) Eqtm)) s0) ((compRenRen_tm xitm zetatm rhotm Eqtm) s1) ((compRenRen_tm xitm zetatm rhotm Eqtm) s2) ((compRenRen_tm xitm zetatm rhotm Eqtm) s3)
    | tBool   => congr_tBool 
    ...
    | tJ  s0 s1 s2 s3 s4 => congr_tJ ((compRenRen_tm (upRen_tm_tm (upRen_tm_tm xitm)) (upRen_tm_tm (upRen_tm_tm zetatm)) (upRen_tm_tm (upRen_tm_tm rhotm)) (up_ren_ren (_) (_) (_) (up_ren_ren (_) (_) (_) Eqtm))) s0) ((compRenRen_tm xitm zetatm rhotm Eqtm) s1) ((compRenRen_tm xitm zetatm rhotm Eqtm) s2) ((compRenRen_tm xitm zetatm rhotm Eqtm) s3) ((compRenRen_tm xitm zetatm rhotm Eqtm) s4)
    | tRefl   => congr_tRefl 
    end.
...
Fixpoint compRenSubst_tm    (xitm : ( fin ) -> fin) (tautm : ( fin ) -> tm ) (thetatm : ( fin ) -> tm ) (Eqtm : forall x, ((funcomp) tautm xitm) x = thetatm x) (s : tm ) : subst_tm tautm (ren_tm xitm s) = subst_tm thetatm s :=
    ...
    | tTrue   => congr_tTrue 
    | tFalse   => congr_tFalse 
    | tIf  s0 s1 s2 s3 => congr_tIf ((compRenSubst_tm (upRen_tm_tm xitm) (up_tm_tm tautm) (up_tm_tm thetatm) (up_ren_subst_tm_tm (_) (_) (_) Eqtm)) s0) ((compRenSubst_tm xitm tautm thetatm Eqtm) s1) ((compRenSubst_tm xitm tautm thetatm Eqtm) s2) ((compRenSubst_tm xitm tautm thetatm Eqtm) s3)
    | tBool   => congr_tBool 
    ...
    | tJ  s0 s1 s2 s3 s4 => congr_tJ ((compRenSubst_tm (upRen_tm_tm (upRen_tm_tm xitm)) (up_tm_tm (up_tm_tm tautm)) (up_tm_tm (up_tm_tm thetatm)) (up_ren_subst_tm_tm (_) (_) (_) (up_ren_subst_tm_tm (_) (_) (_) Eqtm))) s0) ((compRenSubst_tm xitm tautm thetatm Eqtm) s1) ((compRenSubst_tm xitm tautm thetatm Eqtm) s2) ((compRenSubst_tm xitm tautm thetatm Eqtm) s3) ((compRenSubst_tm xitm tautm thetatm Eqtm) s4)
    | tRefl   => congr_tRefl 
    end.
...
Fixpoint compSubstRen_tm    (sigmatm : ( fin ) -> tm ) (zetatm : ( fin ) -> fin) (thetatm : ( fin ) -> tm ) (Eqtm : forall x, ((funcomp) (ren_tm zetatm) sigmatm) x = thetatm x) (s : tm ) : ren_tm zetatm (subst_tm sigmatm s) = subst_tm thetatm s :=
    ...
    | tTrue   => congr_tTrue 
    | tFalse   => congr_tFalse 
    | tIf  s0 s1 s2 s3 => congr_tIf ((compSubstRen_tm (up_tm_tm sigmatm) (upRen_tm_tm zetatm) (up_tm_tm thetatm) (up_subst_ren_tm_tm (_) (_) (_) Eqtm)) s0) ((compSubstRen_tm sigmatm zetatm thetatm Eqtm) s1) ((compSubstRen_tm sigmatm zetatm thetatm Eqtm) s2) ((compSubstRen_tm sigmatm zetatm thetatm Eqtm) s3)
    | tBool   => congr_tBool 
    ...
    | tJ  s0 s1 s2 s3 s4 => congr_tJ ((compSubstRen_tm (up_tm_tm (up_tm_tm sigmatm)) (upRen_tm_tm (upRen_tm_tm zetatm)) (up_tm_tm (up_tm_tm thetatm)) (up_subst_ren_tm_tm (_) (_) (_) (up_subst_ren_tm_tm (_) (_) (_) Eqtm))) s0) ((compSubstRen_tm sigmatm zetatm thetatm Eqtm) s1) ((compSubstRen_tm sigmatm zetatm thetatm Eqtm) s2) ((compSubstRen_tm sigmatm zetatm thetatm Eqtm) s3) ((compSubstRen_tm sigmatm zetatm thetatm Eqtm) s4)
    | tRefl   => congr_tRefl 
    end.
...
Fixpoint compSubstSubst_tm    (sigmatm : ( fin ) -> tm ) (tautm : ( fin ) -> tm ) (thetatm : ( fin ) -> tm ) (Eqtm : forall x, ((funcomp) (subst_tm tautm) sigmatm) x = thetatm x) (s : tm ) : subst_tm tautm (subst_tm sigmatm s) = subst_tm thetatm s :=
    ...
    | tTrue   => congr_tTrue 
    | tFalse   => congr_tFalse 
    | tIf  s0 s1 s2 s3 => congr_tIf ((compSubstSubst_tm (up_tm_tm sigmatm) (up_tm_tm tautm) (up_tm_tm thetatm) (up_subst_subst_tm_tm (_) (_) (_) Eqtm)) s0) ((compSubstSubst_tm sigmatm tautm thetatm Eqtm) s1) ((compSubstSubst_tm sigmatm tautm thetatm Eqtm) s2) ((compSubstSubst_tm sigmatm tautm thetatm Eqtm) s3)
    | tBool   => congr_tBool 
    ...
    | tJ  s0 s1 s2 s3 s4 => congr_tJ ((compSubstSubst_tm (up_tm_tm (up_tm_tm sigmatm)) (up_tm_tm (up_tm_tm tautm)) (up_tm_tm (up_tm_tm thetatm)) (up_subst_subst_tm_tm (_) (_) (_) (up_subst_subst_tm_tm (_) (_) (_) Eqtm))) s0) ((compSubstSubst_tm sigmatm tautm thetatm Eqtm) s1) ((compSubstSubst_tm sigmatm tautm thetatm Eqtm) s2) ((compSubstSubst_tm sigmatm tautm thetatm Eqtm) s3) ((compSubstSubst_tm sigmatm tautm thetatm Eqtm) s4)
    | tRefl   => congr_tRefl 
    end.
...
Fixpoint rinst_inst_tm   (xitm : ( fin ) -> fin) (sigmatm : ( fin ) -> tm ) (Eqtm : forall x, ((funcomp) (var_tm ) xitm) x = sigmatm x) (s : tm ) : ren_tm xitm s = subst_tm sigmatm s :=
    ...
    | tTrue   => congr_tTrue 
    | tFalse   => congr_tFalse 
    | tIf  s0 s1 s2 s3 => congr_tIf ((rinst_inst_tm (upRen_tm_tm xitm) (up_tm_tm sigmatm) (rinstInst_up_tm_tm (_) (_) Eqtm)) s0) ((rinst_inst_tm xitm sigmatm Eqtm) s1) ((rinst_inst_tm xitm sigmatm Eqtm) s2) ((rinst_inst_tm xitm sigmatm Eqtm) s3)
    | tBool   => congr_tBool 
    ...
    | tJ  s0 s1 s2 s3 s4 => congr_tJ ((rinst_inst_tm (upRen_tm_tm (upRen_tm_tm xitm)) (up_tm_tm (up_tm_tm sigmatm)) (rinstInst_up_tm_tm (_) (_) (rinstInst_up_tm_tm (_) (_) Eqtm))) s0) ((rinst_inst_tm xitm sigmatm Eqtm) s1) ((rinst_inst_tm xitm sigmatm Eqtm) s2) ((rinst_inst_tm xitm sigmatm Eqtm) s3) ((rinst_inst_tm xitm sigmatm Eqtm) s4)
    | tRefl   => congr_tRefl 
    end.
