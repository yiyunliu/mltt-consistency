...
% \begin{minipage}{0.8\textwidth}
  \begin{tabular}{ l |  l  | l | l | l }
      & \header{Universes} & \header{Inductives} & \header{Convertibility}
      & \header{Large Elim} \\
    \hline
    ...
    \hline
    POPLmark2 & 1 & Nat & T & {\boxedsymbols ✓} \\
    \hline
    MLTT-a-la-Coq & 1 & Id, Nat & T & {\boxedsymbols ✓} \\
    \hline
    Nuprl & $\mathbb{N}$ & W-Types & E & {\boxedsymbols ✓} \\
    \hline
    Coq-in-Coq & $\mathbb{P}$,$\mathbb{N}$ & General & U & {\boxedsymbols ✓}
...
% \end{minipage}
  ...
  \\
    ...
    POPLmark reloaded \citet{decagda} \\
    MLTT-a-la-Coq \citet{martin-lof-a-la-coq} \\
    Nuprl \citet{anand2014towards} \\
  \\ 
  Universes: Countable ($\mathbb{N}$), One (1), Impredicative ($\mathbb{P}$) \\
  Convertibility: Typed (T), Untyped (U), Extensional (E) \\
  \end{tabular}
