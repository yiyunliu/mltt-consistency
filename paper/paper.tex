...
%  We use Coq's custom notations to ease the
...
script, anticipating that readers may wish to reference and validate our
formalism.  The typeset proofs purposefully follow the mechanized proofs
closely while avoiding, as much as possible, artifacts specific to Coq.
