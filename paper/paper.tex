...
use $[[idtm]]$ as the identity substitution, and the extension operator
...
The substitution operator $[[a {rho}]]$ replaces every free variable $[[x]]$ of
$[[a]]$ by $[[rho x]]$ simultaneously. A single substitution corresponds to
composing extension and identity:
$[[a { b / x }]] \coloneqq [[a { idtm .: x -> b }]]$.

When reasoning about logical relations, it is more convenient to formulate
definitions in terms of simultaneous substitutions than single substitutions,
such as semantic typing in Section~\ref{sec:logrelproof}.
\jc{I've rewritten this paragraph to be more succinct,
but I'm still not certain it's necessary at all.
We're not focussing on the merits of simultaneous substitution over
other representations of substitution and binding, after all.}
