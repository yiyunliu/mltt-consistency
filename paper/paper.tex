...
\yl{I'm not sure how strong of a statement we can make about our proof
  ...
  reason} The short consistency proof we present achieves the goal of
...
it was only needed for subject reduction}
...
out in a structure similar to the one we have presented. \scw{Not sure that 
