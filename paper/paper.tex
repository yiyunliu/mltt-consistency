...
present achieves the goal of ilustrating the technique of proof by
logical relation for dependently typed languages.
In this section, we discuss what attributes to the shortness of our
proof.
...
First, unlike developments that mechanize the correctness of a
...
Second, our logical relation, unlike the ones from \citet{decagda,
...
the extensionality of their type system, wheras \citet{decagda,
...
In \rref{I-Par, I-Bool}, we close over our semantically valid types
and terms using the non-deterministic parallel reduction relation,
...
from the logical relation. \citet{siles2012pure} generalizes the
...
equational theory, and thus allowing subject reduction to be proven
