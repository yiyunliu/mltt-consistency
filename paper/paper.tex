...
\rref{T-Abs}, where induction hypothesis is not helpful since the body
...
The $[[rho |= G]]$ judgment defines the semantic well-formedness of
...
context. However, since we are in a dependently typed system, there
...
We can read $[[wne a]]$ and $[[wn a]]$ as weakly normalizing to a neutral or a normal form respectively.
