...
has a normal form, then we know tha the term must have a normal form.
...
% \begin{minipage}{0.8\textwidth}
  \begin{tabular}{ l |  l  | l | l | l }
      & Universe & Inductives & Convertibility & Large Elim \\
    \hline
    \lang{} & Countable & Id, Bool & Untyped & {\boxedsymbols ✓} \\
    \hline
    \citet{nbeincoq} & One & Nat & Typed & {\boxedsymbols ✗} \\
    \hline
    \citet{decagda} & One & Nat & Typed & {\boxedsymbols ✓} \\
    \hline
    \citet{martin-lof-a-la-coq} & One & Id, Nat & Typed & {\boxedsymbols ✓} \\
    \hline
    \citet{anand2014towards} & Countable & W-Types & Extensional &
                                                                   {\boxedsymbols
                                                                   ✓} \\
    \hline
    \citet{barras2012semantical} & Impred,Countable & General
                                   & Untyped & {\boxedsymbols ✓}
  ...
  \end{tabular}
% \end{minipage}
  \caption{Overview of Language Features}
  \label{fig:linecount}
\end{figure}
