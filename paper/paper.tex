...
results\scw{stronger than what?} related to the decidability of type conversion or type
...
start from logical relations for simply typed languages,\scw{proving 
results such as \ldots} and
...
Does Aspinall and Hofmann's chapter of ATTAPL include a logical relation?}
\scw{Seems like you should also mention POPLmark reloaded somehere too?}
 \citet{harperkripke} gives a gentle introduction on how
...
important features\scw{list these features explicitly: 
large eliminations, indexed types, others? \ldots}  that are only available or require special treatments in
