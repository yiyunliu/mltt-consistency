...
But this is not the case. \scw{Add a sentence about pen-and-paper LR proofs
  ...
  case, but I don't know if the reviewers will agree)} Recent authors have developed tour-de-force
...
300,000 lines of code. As a result, their use of logical relations are
...
\yl{Added the related work at the beginning but I wonder if we should
  just say that we want to match our expressiveness with existing systems}

\citet{nbeincoq,decagda,martin-lof-a-la-coq} all
...
$\beta\eta$-normal forms after we add the function $\eta$ law to our
equational theory.
...
universe hierarchy still relies on impredicativity, similar to our
development.
% \scw{How did the Nuprl
