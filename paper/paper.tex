...
\title{Short and Mechanized Logical Relation for Dependent Types}
...
Section~\ref{sec:logrelproof}. For conciseness, we refer to this system
as \lang.

The syntax of \lang can be found in Figure~\ref{fig:syntax}.
We use the unscoped de Bruijn representation for both our Coq development and
...
$[[G]]$. In \rref{T-J}, the elimination form for the identity type,
the terms $[[a]]$ and $[[A]]$ need to be shifted in the context for a similar
...
% \end{minipage}
  ...
  \begin{tabular}{l}
  \\
    $\lambda^\theta$ (logical fragment only) \citet{casinghino:combining-proofs-programs} \\
