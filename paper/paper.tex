...
functionality and inversion properties to justify the existence of a
fixed point with \rref{I-PiAlt}, we opt for our current
...
the immediate admissibility of \rref{I-PiAlt} and the inversion
principle (Lemma~\ref{lemma:piinvalt}) we derive after proving functionality.
