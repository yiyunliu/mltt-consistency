...
cost of introducing divergence. Its logical fragment supports a
proof-irrelevant identity type, which can be used to reason about the
behavior of its programmatic fragment.
