...
\begin{lemma}[Inversion of the logical relation]
  ...
  \item\footnote{\dotv{semtyping.v}{InterpExt\_Fun\_inv}} If $[[Interp I i Pi A B S0]]$, then there exists $[[S]],[[F]]$ such that:
    \begin{itemize}
    \item $[[Interp I i A S ]]$
...
\begin{proof}
  ...
  \item[\Rref{I-Red}:] We are given that $[[Interp I i Pi A B S0]]$.
    ...
    \item $[[forall a, (# a in S implies Interp I i B { a } F a #)]]$
    \end{itemize}
    These properties are exactly the ones from the conclusion.
  \end{description}
\end{proof}
...
\subsection{More detailed proofs}
