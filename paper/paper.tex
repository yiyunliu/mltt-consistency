...
\scw{Some researchers distinguish between derivable rules (those that 
are simple corollaries), and admissible rules (those that must be proven 
via induction.)}
...
For the majority of the properties that we prove in this section, we
